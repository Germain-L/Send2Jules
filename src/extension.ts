...
import { UI_CONFIG, MESSAGES, URLS } from './constants';
    ...
    context.subscriptions.push(vscode.commands.registerCommand('julesBridge.sendFlow', async () => {
        try {
            ...
            const userPrompt = await vscode.window.showInputBox({
                title: MESSAGES.PROMPT_INPUT_TITLE,
                prompt: MESSAGES.PROMPT_INPUT_PROMPT,
                value: autoPrompt,
                placeHolder: MESSAGES.PROMPT_INPUT_PLACEHOLDER
            });
